...
from insurance.constant import CONFIG_DIR,CURRENT_TIME_STAMP
from insurance.pipeline.pipeline import Pipeline
from insurance.entity.insurance_predictor import InsurancePredictor, InsurancePremiumData
...
@application.route('/artifact', defaults={'req_path': 'insurance_premium'})
